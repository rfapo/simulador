...
class ParametrosControllerTest < ActionController::TestCase
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post :create, parametro: { demanda: @parametro.demanda, empresa_id: @parametro.empresa_id, tarifa: @parametro.tarifa }
    end
  ...
  test "should update parametro" do
    patch :update, id: @parametro, parametro: { demanda: @parametro.demanda, empresa_id: @parametro.empresa_id, tarifa: @parametro.tarifa }
    assert_redirected_to parametro_path(assigns(:parametro))
  end
